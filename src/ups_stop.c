...
static t_upslst_item *stop_core(const t_upsugo_command * const a_command_line,
 ...
 * ups_stop
 *
 * Find the instance the user has requested, and process the stop actions.
 *
	       ...
	       const FILE * const a_temp_file, const int a_ups_command)
{
  ...
  mproduct_list = stop_core(a_command_line, a_temp_file, a_ups_command);
