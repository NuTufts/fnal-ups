...
static t_upskey_map g_key_map[] =
{
  ...
  { e_key_info_files,       "INFO_FILES",       NO,   22,   NO, 0x00000010 },
  { e_key_man_files,        "MAN_FILES",        NO,   23,   NO, 0x00000010 },
  { e_key_news_files,       "NEWS_FILES",       NO,   24,   NO, 0x00000010 },
  ...
  { e_key_html_path,        "HTML_PATH",        NO,   NO,    7, 0x00001000 },
  { e_key_news_path,        "NEWS_PATH",        NO,   NO,    8, 0x00001000 },
  { e_key_upd_usercode,     "UPD_USERCODE",     NO,   NO,    9, 0x00001000 },
