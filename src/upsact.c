...
t_cmd_info g_cmd_info[] = {
  ...
  {e_depend,      "depend",      "?cdf:g:H:jK:lm:M:noOq:r:RtU:vVz:Z0123", 0x00000010, e_invalid_action},
...
/*  {e_modify,      "modify",      "?aA:E:f:H:m:M:Np:q:r:T:U:vVz:Z", 0x00000010, e_invalid_action},	*/
  ...
  {e_verify,      "verify",      "?acdf:g:H:m:M:noq:r:tU:vz:Z0123", 0x00000010, e_invalid_action},
